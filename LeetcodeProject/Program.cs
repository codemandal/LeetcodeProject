...
namespace LeetcodeProject
{
    class Program
    {
        ...
        {
            /*TwoSum*/
            //int[] arr_a = new int[] { 1, 1, 1, 1, 1, 4, 1, 1, 1, 1, 1, 7, 1, 1, 1, 1, 1 };
            //int target = 11;
            //int[] ans = TwoSum(arr_a, target);
            //Console.WriteLine(ans);

            /*Palindrome*/
            //int n = 12321;
            //if (IsPalindrome(n))
            //    Console.WriteLine("Palindorme");
            //else
            //    Console.WriteLine("Not Palindorme");


            /*BinarySearch*///O(log n)
                            //int[] arr = new int[] { 1, 4, 6, 8, 10, 11,13,15,16 };
                            //int target = 2;
                            //if (IsFoundBinarySearch(arr, 0, arr.Length-1, target))
            ...
            /*Merge Sort*/// O(n Log n)
                          //int[] arr = new int[] { 3, 6, 1, 0 };//{ 12, 3, 16, 6, 5, 1 };
                          //int[] restularr = MergeSort(arr);
                          //foreach (int i in restularr)
                          //{
                          //    Console.Write("{0} ", i);
                          //}
            ///
            /* Fibonacci *///(O 2n) exponential time complexity 2 to the power of n
                           //Fibo(0, 1, 1, 8);
            ...
            // ReverseWordsinString.ReverseWords2(s);
            //string s = "[([]])";
            ...
            //if (_217ContainsDuplicate.ContainsDuplicate(arr))
            //    Console.WriteLine("true");
            //else
            //    Console.WriteLine("false");

            // Finding Pivot index
            //var nums = new int[]{2, 1, -1};// { 1, 7, 3, 6, 5, 6 };
            //Console.WriteLine(FindPivotIndex.PivotIndex(nums));

            //Largest Number At Least Twice of Others
            //var nums = new int[] { 0, 0, 0, 1 }; //{ 1, 2, 3, 4 };
            //Console.WriteLine(DominantIndex.GetDominantIndex(nums));

            //Plus One
            //var digits = new int[] { 9, 8, 7, 6, 5, 4, 3, 2, 1, 0 }; //{ 4, 3, 2, 1 };
            //var ans = PlusOne.GetPlusOne(digits);
            ...
            //Duplicate Zeros
            ////var digits = new int[] {1, 0, 2, 3, 0, 4, 5, 0}; //{ 4, 3, 2, 1 };
            ////var ans = DuplicateZeros.GetDuplicateZeros(digits);
            ////foreach (int i in ans)
            ////{
            ////    Console.Write("{0} ", i);
            ////}
            ...
            ////MyArray.Traverse(a,size);
            ////a = MyArray.InsertAtIndex(a, 2, 10);
            ////size++;
            ////Console.WriteLine("After inserting at index 2");
            ////MyArray.Traverse(a,size);
            ////a = MyArray.Insertfirst(a, 20);
            ////size++;
            ////Console.WriteLine("After inserting at first");
            ////MyArray.Traverse(a,size);

            ////a = MyArray.Insertlast(a, 30,size);
            ////Console.WriteLine("After inserting at last");
            ////size++;
            ////MyArray.Traverse(a,size);
            ////a = MyArray.RemoveAtIndex(a, 2);
            ////Console.WriteLine("After removing at index 2");
            ////size--;
            ////MyArray.Traverse(a,size);
            ////a = MyArray.RemoveFirst(a);
            ...
            ////size--;
            ////MyArray.Traverse(a, size);
            ////Console.WriteLine("Now size =" + size);
            ///
            //var nums = new int[] { 0, 1, 2, 2, 3, 0, 4, 2 };
            //Console.WriteLine(MyArray.RemoveElement(nums,2));

            //var nums = new int[] { 0,0,1,1,1,2,2,3,3,4 };
            //var nums = new int[] { 1, 1, 2 };
            //Console.WriteLine(MyArray.RemoveDuplicates(nums));

            //var nums = new int[] {  3, 1, 7, 11};
            //Console.WriteLine(MyArray.CheckifdoubleExist(nums));

            //var nums = new int[] { 0, 2,3,5,2,1,0 };
            //Console.WriteLine(MyArray.ValidMountainArray(nums));

            // var nums = new int[] { 17, 18, 5, 4, 6, 1 };

            //nums = MyArray.ReplacementElementsOptimum(nums);
            //foreach (int i in nums)
            //{
            //    Console.WriteLine("{0}", i);
            //}
            ////var nums = new int[] { 0, 0, 1, 1, 1, 2, 2, 3, 3, 4 };
            ////nums = MyArray.DeleteDuplicatesInPlace(nums);
            ////foreach (int i in nums)
            ////{
            ////    Console.WriteLine("{0}", i);
            ////}
            ...
            //var nums1 =new int[] { 1,2,4,6,8};
            //var nums2 = new int[] { -1, -2, -4, 0, 3, 7, 9, 10 };
            //var ans = MyArray.MergeTwoSortedArrays(nums1, nums2);
            //foreach (int i in ans)
            //{
            //    Console.WriteLine("{0}", i);
            //}
            ...
            //  var nums1 = new int[] { 1, 3 }; //{ 1 };
            //   var nums2 = new int[] { };//{ 3,4 };
            //  var nums1 = new int[] { 1, 3 };//{ 1, 3, 8, 9, 15 }; //{ 1, 3 };
            // var nums2 = new int[] { 2 };//{ 7, 11, 18, 19, 21, 25 };//{ 1, 3, 8, 9, 15 };
            //// var nums1 = new int[] { 1, 3, 8, 9, 15 }; //{ 1, 3 };
            //// var nums2 = new int[] { 7, 11, 18, 19, 21, 25 };//{ 1, 3, 8, 9, 15 };
            // var ans = MyArray.FindMedianSortedArray(nums1, nums2);
            // Console.WriteLine("Median=" + ans.ToString());
            ...
            //string s = "A man, a plan, a canal: Panama";
            //Console.WriteLine(ArraysandStrings.IsPalindrome(s));


            ///// Sorting algorithms
            //1. Counting Sort
            //int[] a = new int[] { 2,1,1,0,2,5,4,0,2,8,7,7,9,2,0,1,9};
            //var ans = SortingAlgorithms.CountingSort(a, a.Length);
            //foreach (int i in ans)
            //{
            //    Console.WriteLine("{0}", i);
            //}
            ...
            //2. Bubble Sort
            //int[] a = new int[] { 16,14,5,6,8 };
            //var ans = SortingAlgorithms.BubbleSort(a);
            //foreach (int i in ans)
            //{
            //    Console.WriteLine("{0}", i);
            //}
            ...
            //////////////////////////////380 Insert Delete Get Random O1 ///////////////////////
            ////_380InsertDeleteGetRandomO1 obj = new _380InsertDeleteGetRandomO1();
            ////bool param_1 = obj.Insert(10);
            ////bool q = obj.Insert(3);
            ////bool w = obj.Insert(57);
            ////bool r = obj.Insert(5);
            ////bool rt= obj.Insert(40);
            ...
            //    Console.WriteLine(" ");
            //    Console.WriteLine();
            //    Console.WriteLine("IIterative norder Traversal : ");
            //    BST.iterativeInOrder(BST.ReturnRoot());
            //    Console.WriteLine(" ");
            //    Console.WriteLine();
            ...
            //BST.iterativePreOrder(BST.ReturnRoot());
            ...
            //obj.Insert(5);
            //obj.Insert(8);
            //var lst = obj.PreorderTraversal(obj.ReturnRoot());


            ///////////////////////////////////////// Binary Level Order Traverse //////////////////////////////////
            //var obj = new _102BinaryTreeLevelOrderTraversal();
            //var root = new TreeNode(3);
            //root.left = new TreeNode(9);
            //root.right = new TreeNode(20);
            //root.right.left = new TreeNode(15);
            //root.right.right = new TreeNode(7);
            //var lst = obj.LevelOrder(root);
            //var dict = new Dictionary<string, int>();
            //dict.Add("J", 10);
            //dict.Add("H", 5);
            //dict.Add("S", 2);
            //ShopifyCoding.FindLocation(dict);

            ////////////////////////////////////////////// Find Median of a running array ///////////////
            ////var arr = new List<int>();

            ////for (int i = 0; i < 5; i++)
            ////{
            ////    arr.Add(Convert.ToInt32(Console.Read()));
            ////    var abc = MyArray.getMediansofRunningArray(arr.ToArray());
            ////    foreach(var a in abc)
            ////        Console.WriteLine("Median = " + a.ToString());

            ////}
            ///
            ////////////////////////////////////////////// Bunny Worker locations ///////////////
            // Console.WriteLine("ID:" + bunny_worker_locations.solution(3, 3));

            //////// Longest Valid Parentheses
            // Console.WriteLine("count is :" + _32LongestValidParentheses.longestValidParentheses("()(()"));

            //////////////////////34. Find First and Last Position of Element
            ////int[] nums = new int[] { 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 10 };//// { 5, 7, 7, 8, 8,10 };
            ////int target = 8;
            ////var ans = _34Find_First_and_Last_Position_of_Element_in_Sorted_Array.SearchRange(nums, target);
            ////System.Console.WriteLine("ans=[" + ans[0] + "," + ans[1] + "]");
            ...
            //   string[] words = new string[] { "qfskkpfakjretogrokmxemjjbvgmmqrfdxlkfvycwalbdeumav", "wjgjhlrpvhqozvvkifhftnfqcfjmmzhtxsoqbeduqmnpvimagq", "ibxhtobuolmllbasaxlanjgalgmbjuxmqpadllryaobcucdeqc", "ydlddogzvzttizzzjohfsenatvbpngarutztgdqczkzoenbxzv", "rmsakibpprdrttycxglfgtjlifznnnlkgjqseguijfctrcahbb", "pqquuarnoybphojyoyizhuyjfgwdlzcmkdbdqzatgmabhnpuyh", "akposmzwykwrenlcrqwrrvsfqxzohrramdajwzlseguupjfzvd", "vyldyqpvmnoemzeyxslcoysqfpvvotenkmehqvopynllvwhxzr", "ysyskgrbolixwmffygycvgewxqnxvjsfefpmxrtsqsvpowoctw", "oqjgumitldivceezxgoiwjgozfqcnkergctffspdxdbnmvjago", "bpfgqhlkvevfazcmpdqakonkudniuobhqzypqlyocjdngltywn", "ttucplgotbiceepzfxdebvluioeeitzmesmoxliuwqsftfmvlg", "xhkklcwblyjmdyhfscmeffmmerxdioseybombzxjatkkltrvzq", "qkvvbrgbzzfhzizulssaxupyqwniqradvkjivedckjrinrlxgi", "itjudnlqncbspswkbcwldkwujlshwsgziontsobirsvskmjbrq", "nmfgxfeqgqefxqivxtdrxeelsucufkhivijmzgioxioosmdpwx", "ihygxkykuczvyokuveuchermxceexajilpkcxjjnwmdbwnxccl", "etvcfbmadfxlprevjjnojxwonnnwjnamgrfwohgyhievupsdqd", "ngskodiaxeswtqvjaqyulpedaqcchcuktfjlzyvddfeblnczmh", "vnmntdvhaxqltluzwwwwrbpqwahebgtmhivtkadczpzabgcjzx", "yjqqdvoxxxjbrccoaqqspqlsnxcnderaewsaqpkigtiqoqopth", "wdytqvztzbdzffllbxexxughdvetajclynypnzaokqizfxqrjl", "yvvwkphuzosvvntckxkmvuflrubigexkivyzzaimkxvqitpixo", "lkdgtxmbgsenzmrlccmsunaezbausnsszryztfhjtezssttmsr", "idyybesughzyzfdiibylnkkdeatqjjqqjbertrcactapbcarzb", "ujiajnirancrfdvrfardygbcnzkqsvujkhcegdfibtcuxzbpds", "jjtkmalhmrknaasskjnixzwjgvusbozslrribgazdhaylaxobj", "nizuzttgartfxiwcsqchizlxvvnebqdtkmghtcyzjmgyzszwgi", "egtvislckyltpfogtvfbtxbsssuwvjcduxjnjuvnqyiykvmrxl", "ozvzwalcvaobxbicbwjrububyxlmfcokdxcrkvuehbnokkzala", "azhukctuheiwghkalboxfnuofwopsrutamthzyzlzkrlsefwcz", "yhvjjzsxlescylsnvmcxzcrrzgfhbsdsvdfcykwifzjcjjbmmu", "tspdebnuhrgnmhhuplbzvpkkhfpeilbwkkbgfjiuwrdmkftphk", "jvnbeqzaxecwxspuxhrngmvnkvulmgobvsnqyxdplrnnwfhfqq", "bcbkgwpfmmqwmzjgmflichzhrjdjxbcescfijfztpxpxvbzjch", "bdrkibtxygyicjcfnzigghdekmgoybvfwshxqnjlctcdkiunob", "koctqrqvfftflwsvssnokdotgtxalgegscyeotcrvyywmzescq", "boigqjvosgxpsnklxdjaxtrhqlyvanuvnpldmoknmzugnubfoa", "jjtxbxyazxldpnbxzgslgguvgyevyliywihuqottxuyowrwfar", "zqsacrwcysmkfbpzxoaszgqqsvqglnblmxhxtjqmnectaxntvb", "izcakfitdhgujdborjuhtwubqcoppsgkqtqoqyswjfldsbfcct", "rroiqffqzenlerchkvmjsbmoybisjafcdzgeppyhojoggdlpzq", "xwjqfobmmqomhczwufwlesolvmbtvpdxejzslxrvnijhvevxmc", "ccrubahioyaxuwzloyhqyluwoknxnydbedenrccljoydfxwaxy", "jjoeiuncnvixvhhynaxbkmlurwxcpukredieqlilgkupminjaj", "pdbsbjnrqzrbmewmdkqqhcpzielskcazuliiatmvhcaksrusae", "nizbnxpqbzsihakkadsbtgxovyuebgtzvrvbowxllkzevktkuu", "hklskdbopqjwdrefpgoxaoxzevpdaiubejuaxxbrhzbamdznrr", "uccnuegvmkqtagudujuildlwefbyoywypakjrhiibrxdmsspjl", "awinuyoppufjxgqvcddleqdhbkmolxqyvsqprnwcoehpturicf" };
            //string s = "abcde";
            // string[] words = new string[] { "a", "bb", "acd", "cda" };
            ////string s = "dsahjpjauf";
            ////string[] words = new string[] { "ahjpjau", "ja", "ahbwzgqnuk", "tnmlanowax" , "fja"};
            ////var ans = _792NumberofMatchingSubsequences.NumMatchingSubseq(s, words);
            ////Console.WriteLine(ans);
            ...
            //root.right.right.right.right.right = new TreeNode() {val = 6};

            //    _114FlattenBinaryTreetoLinkedList.Flatten(root);

            //var ans = (_242ValidAnagrm.IsAnagram("anagram", "nagaram")) ? "Yes" : "No";
            //Console.WriteLine(ans);
            ...
            ////Console.WriteLine(AddTwoNumbersArray.AddTwoNumbers(a, b));

            ////////// Find Logest Binary Gap//////
            int N = 1041;

            Console.WriteLine(FindLongestBinaryGap.FindGap(N));

        }
        private static void firstcallfrommain()
        {
            SingletonLazy singleLazy = SingletonLazy.Instance;
            singleLazy.PrintDetails("Logging: first call from Main is successful");
            // Console.WriteLine("Logging: first call ");
        }

        private static void secondcallfrommain()
        {
            SingletonLazy singleLazy = SingletonLazy.Instance;
            singleLazy.PrintDetails("Logging:second call from Main is successful");
            //Console.WriteLine("Logging: second call ");
        }
        ...
        public static int reverse(int originalno, int temp)
        {
            if (originalno == 0)
                return temp;

            temp = (temp * 10) + (originalno % 10);

            return reverse(originalno / 10, temp);
        }

        public static bool IsPalindromeNonRecur(int x)
        {
            if (x < 0 || x % 10 == 0 && x != 0)
                return false;
        ...
        public static bool IsFoundBinarySearch(int[] arr, int start, int end, int target)
        {
            ...
            int midindex = (int)Math.Floor((decimal)(arr.Length / 2));
            ...
            if (arr[midindex] > target)
            {
                return IsFoundBinarySearch(arr.Take(midindex).ToArray(), start, midindex - 1, target);
            }
            else
            {
                return IsFoundBinarySearch(arr.Skip(midindex).ToArray(), midindex + 1, end, target);
            }
        ...
        public static int[] MergeSort(int[] arr) // This is O(nlog n) time complexity
        {
            if (arr.Length < 2)
                return arr;

            int middleIndex = (int)Math.Floor((double)arr.Length / 2);
            int[] leftarr = arr.Take(middleIndex).ToArray();
            int[] rightarr = arr.Skip(middleIndex).ToArray();

            return Merge(MergeSort(leftarr), MergeSort(rightarr));
        }

        public static int[] Merge(int[] leftarr, int[] rightarr) // This is O(n) time complexity
        {
            ...
            while (lindex < leftarr.Length && rindex < rightarr.Length)
            {
                ...
                {
                    resultarr.Add(leftarr[lindex]);
                    lindex += 1;
                }
                else
                {
                    resultarr.Add(rightarr[rindex]);
                    rindex += 1;
                }
            }


            return resultarr.Concat(leftarr.Skip(lindex)).Concat(rightarr.Skip(rindex)).ToArray();


        }

        public static void Fibo(int a, int b, int counter, int len)
        {
            if (counter <= len)
            {
                Console.Write("{0} ", a);
                Fibo(b, a + b, counter + 1, len);
            }
        ...
        public static int RomanToInt(string s)
        {
            ...
            for (int i = 0; i < s.Length; i++)
            {
                ...
                if (i < s.Length - 1 && GetValue(arrs[i].ToString()) < GetValue(arrs[i + 1].ToString()))
                {
                    Sum = Sum + GetValue(arrs[i].ToString() + arrs[i + 1].ToString());
                    i += 1;
                }
                else
                {
                    Sum = Sum + GetValue(arrs[i].ToString());
                }
            }
            return Sum;
        }
        ...
        {
            Dictionary<string, int> hashstrs = new Dictionary<string, int>();
            foreach (string s in strs)
            {
                if (!hashstrs.ContainsKey(s))
                    hashstrs.Add(s, s.Length);
            }

            string prefix = "";
            string smallestString = hashstrs.OrderBy(s => s.Value).First().Key;
            for (int i = 0; i < smallestString.Length; i++)
            {
                bool exist = false;
                foreach (var k in hashstrs)
                {
                    if (k.Key.ToArray()[i] == smallestString.ToArray()[i])
                        exist = true;
                    else
                        return prefix;
                ...
                if (exist)
                    prefix = prefix + smallestString.ToArray()[i];
            }
        ...
        public static bool IsValid(string s)
        {
            ...
            int lenofS1 = s.ToCharArray().Where(c => c == '(').Count();
            int lenofS2 = s.ToCharArray().Where(c => c == ')').Count();
            int lenofS3 = s.ToCharArray().Where(c => c == '{').Count();
            int lenofS4 = s.ToCharArray().Where(c => c == '}').Count();
            int lenofS5 = s.ToCharArray().Where(c => c == '[').Count();
            int lenofS6 = s.ToCharArray().Where(c => c == ']').Count();

            if (lenofS1 == lenofS2 && lenofS3 == lenofS4 && lenofS5 == lenofS6)
                return true;
        ...
        public static bool IsPalindrome(string s) {
            ...
            //string leftstring = s.Substring(0,midindex);
            //string rightstring = s.Substring(midindex,s.Length-midindex);

            string leftstring = s.Substring(0, midindex);
            string rightstring = s.Substring(midindex, s.Length - midindex);
            var revstring = new string(rightstring.ToCharArray().Reverse().ToArray());

            if (rightstring.Length > leftstring.Length)
            {
                revstring = revstring.Substring(0, leftstring.Length);
            }
            else
            {
                leftstring = leftstring.Substring(0, rightstring.Length);
            }

            if (leftstring == revstring)
                return true;
            ...
            //     int i = 0;
            //   int j = rightstring.Length-1;
            // int length = (rightstring.Length > leftstring.Length) ? leftstring.Length : rightstring.Length;


            //while (i < length)
            //{
            //    if (leftstring.ToArray()[i] == rightstring.ToArray()[j])
            //        isMatch = true;
            //    else
            //        return false;
